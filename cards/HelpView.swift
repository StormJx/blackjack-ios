...
struct HelpView: View {
    ...
    var body: some View {
        NavigationStack {
            List {
                Section {
                    Text("比点数接近 21 且不爆牌。庄家点数小于 17 必须要牌，大于等于 17 停牌（软 17 同停）。玩家回合开局两张时可「加倍」（再押等额、只补一张）。天然黑杰克赔率 3:2，普通获胜 1:1，平局退注。")
                } header: {
                    Text("基本规则")
                }
                ...
                Section {
                    Text("本应用面向练习与娱乐，规则为简化版赌场二十一点，不等同于线下赌场全部选项（如分牌、保险、投降等尚未开放）。")
                } header: {
                    Text("说明")
                }
            }
